...
class GlobalColors: NSObject {
    ...
    class var lightModeSolidColorSpecialKey: UIColor { get { return UIColor(red: CGFloat(182)/CGFloat(255), green: CGFloat(186)/CGFloat(255), blue: CGFloat(194)/CGFloat(255), alpha: 0.83) }}
