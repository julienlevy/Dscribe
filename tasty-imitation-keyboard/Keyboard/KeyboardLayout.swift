...
class GlobalColors: NSObject {
    ...
    class var lightModeSolidColorSpecialKey: UIColor { get { return UIColor(red: CGFloat(96)/CGFloat(255), green: CGFloat(96)/CGFloat(255), blue: CGFloat(88)/CGFloat(255), alpha: 0.30) }}
...
class KeyboardLayout: NSObject, KeyboardKeyProtocol {
    ...
    func updateKeyCap(_ key: KeyboardKey, model: Key, fullReset: Bool, uppercase: Bool, characterUppercase: Bool, shiftState: ShiftState) {
        if fullReset {
            ...
            default:
                key.label.font = key.label.font.withSize(25)
                if #available(iOSApplicationExtension 8.2, *) {
                    key.label.font = UIFont.systemFont(ofSize: 25, weight: UIFontWeightLight)
                }
            }
