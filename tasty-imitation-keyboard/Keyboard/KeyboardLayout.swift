...
class GlobalColors: NSObject {
    ...
    class var lightModeSolidColorSpecialKey: UIColor { get { return UIColor(red: CGFloat(171)/CGFloat(255), green: CGFloat(178)/CGFloat(255), blue: CGFloat(186)/CGFloat(255), alpha: 1) }}
