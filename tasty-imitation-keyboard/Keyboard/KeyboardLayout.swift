...
class GlobalColors: NSObject {
    ...
    class var lightModeSolidColorSpecialKey: UIColor { get { return UIColor(red: CGFloat(187)/CGFloat(255), green: CGFloat(194)/CGFloat(255), blue: CGFloat(201)/CGFloat(255), alpha: 1) }}
