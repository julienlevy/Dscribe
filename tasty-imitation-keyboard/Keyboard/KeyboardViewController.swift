...
class KeyboardViewController: UIInputViewController {
    ...
    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
        ...
        let keyboardType = UserDefaults(suiteName: "group.dscribekeyboard")!.object(forKey: kKeyboardType) as? String
...
//            var readyForDoubleSpacePeriod: Bool = true
    ...
    func handleAutoPeriod(_ key: Key) {
        if !UserDefaults(suiteName: "group.dscribekeyboard")!.bool(forKey: kPeriodShortcut) {
            return
        }
    ...
    func shouldAutoCapitalize() -> Bool {
        if !UserDefaults(suiteName: "group.dscribekeyboard")!.bool(forKey: kAutoCapitalization) {
            return false
        }
    ...
    func playKeySound() {
        if !UserDefaults(suiteName: "group.dscribekeyboard")!.bool(forKey: kKeyboardClicks) {
            return
        }
